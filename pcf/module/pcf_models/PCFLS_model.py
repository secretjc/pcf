...
This file reads topology, traffic matrix, tunnel, and implements the PCFLS model in gurobi format.
...
def create_base_model(is_symmetric, data):
  ...
  # Variable definition
  r, a, a0, b0, p, pi, lambda_, amu, bmu, theta, asigma, bsigma, aphi, bphi = {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}
  ...
  for i, j in node_pairs:
    for e1, e2 in arcs:
      ...
      m.addConstr(
        ...
        quicksum(- bphi[l,i,j] for l in impact[e1,e2] if l in btunnels[i, j] or l in btraverse[i, j])+ 
...
def compute_mlu(
  ...
  r, pi, lambda_, amu, bmu, a0, b0, aphi, bphi, a, p, asigma, bsigma, theta = {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}
